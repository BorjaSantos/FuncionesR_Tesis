...
simulacion_datos <- function(n.estudios,m1.trat,sd1.trat,m1.ctrl,sd1.ctrl,a1,b1,m2.trat,sd2.trat,m2.ctrl,sd2.ctrl,a2,b2,
                             m3.trat,sd3.trat,a3,b3,m4,trat,sd4.trat,m4.ctrl,sd4.ctrl,a4,b4,tamano.muestra,semilla,
                             replicaciones){
...
simulacion_datos2 <- function(n.estudios,m1.trat,sd1.trat,m1.ctrl,sd1.ctrl,a1,b1,m2.trat,sd2.trat,m2.ctrl,sd2.ctrl,a2,b2,
  ...
  for(i in 1:replicaciones){
    ...
    Var4.Trat <- round(rtrunc(tamano.muestra,spec="norm",a=a4,b=b4,mean=m4.trat,sd=sd4.trat),0) # Puntuaciones PANSS general tratamiento
    Var4.Ctrl <- round(rtrunc(tamano.muestra,spec="norm",a=a4,b=b4,mean=m4.ctrl,sd=sd4.ctrl),0) # Puntuaciones PANSS general control
...
g_hedges_simulacion2_4vars <- function(database,correlacion12=0,
                                       correlacion13=0,correlacion14=0,correlacion23=0,correlacion24=0,correlacion34=0){
  library(compute.es)
  datos_meta <- diag(0,length(database),14)
  for(i in 1:replicaciones){
...
g_hedges_simulacion_4vars <- function(database,correlacion12=0,
                                      correlacion13=0,correlacion14=0,correlacion23=0,correlacion24=0,correlacion34=0){
  library(compute.es)
...
#datos <- g_hedges_simulacion2_4vars(database,correlacion12=0,correlacion13=0,correlacion14=0,correlacion23=0,correlacion24=0,
#                                    correlacion34=0)
...
#datos <- g_hedges_simulacion_4vars(database,correlacion12=0,correlacion13=0,correlacion14=0,correlacion23=0,correlacion24=0,
#                                   correlacion34=0)
